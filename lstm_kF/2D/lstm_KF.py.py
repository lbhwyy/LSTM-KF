...
if __name__ == '__main__':
    ...
    # 检测到的路径
    path = r'E:\View of Delft dataset\Pytorch-lstm-forecast-main\Pytorch-lstm-forecast-main\true.csv'
    ...
    legend = ['观测的x中心值', '观测的y中心值', '卡尔曼滤波加lstm的x值', '卡尔曼滤波加lstm的y值',"sort预测的x值","sort预测的y值"]
